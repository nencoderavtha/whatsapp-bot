...
export async function buildSystemPrompt(
  ...
  const staticPrompt = await getCached(restaurantId, "staticSystemPrompt", async () => {
    ...
    const scopeBlock =
      ...
      `When a customer chooses "delivery" or asks for delivery: ALWAYS ask for their full delivery address & landmark before confirming. Delivery fee of ₹45 is automatically included in the grand total.\n\n` +
